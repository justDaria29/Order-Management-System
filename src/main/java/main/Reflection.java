...
public class Reflection {
     ...
     *
     * @param object the object whose fields are to be counted
     * @return the number of fields in the object's class
     */
     ...
     *
     * @param object the object whose field names are to be retrieved
     ...
     *
     * @param object the object whose field values are to be retrieved
